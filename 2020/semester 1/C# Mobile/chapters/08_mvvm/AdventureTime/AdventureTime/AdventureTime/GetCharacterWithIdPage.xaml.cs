...
namespace AdventureTime
{
    ...
    public partial class GetCharacterWithIdPage : ContentPage
    {
        public GetCharacterWithIdPage()
        {
            ...
            InitializeAmountOfCharacters();
        }

        private async void InitializeAmountOfCharacters()
        {
            amountOfCharacters.Text = $"(Amount of characters: {await App.Database.GetAmountOfCharacters()})";
        }
